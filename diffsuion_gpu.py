...
# 
# 请注意有关于扩散模型的[几个观点](https://twitter.com/sedielem/status/1530894256168222722?s=20&t=mfv4afx1GcNQU5fZklpACw)。本文我们采用离散时间（潜在变量模型）的观点，但请务必查看其他观点。
